...
let s:N1 = [ '#141413' , '#B5D3F3' , 232 , 153 ] " mode
let s:N2 = [ '#B5D3F3' , '#32322F' , 153 , 238 ] " info
let s:N3 = [ '#B5D3F3' , '#242424' , 153 , 235 ] " statusline
let s:N4 = [ '#7CB0E6' , 111 ]                   " mode modified
                
" Insert mode
let s:I1 = [ '#141413' , '#CAE682' , 232 , 82 ] 
let s:I2 = [ '#CAE682' , '#32322F' , 192 , 238 ] 
let s:I3 = [ '#CAE682' , '#242424' , 192 , 235 ] 
let s:I4 = [ '#86CD74' , 82 ]   
...
let s:V3 = [ '#FDE76E' , '#242424' , 227 , 235 ]
let s:V4 = [ '#FADE3E' , 221 ]   

" Replace mode
let s:R1 = [ '#141413' , '#E5786D' , 232 , 124 ]
